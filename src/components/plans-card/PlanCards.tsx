...
export const PlanCards = () => {
  return (
    <div>
      <Row>
        <Col xs={8}>
          <div className="p-6 border border-off-white rounded-3xl">
            <span>
            ...
            <button className="rounded-full border border-off-white py-3 px-6 flex justify-center items-center gap-3">
              <p>Book now</p>
              <span>
